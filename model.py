...
class FixCapsNet(nn.Module):
    def _init_(self,conv_inputs,conv_outputs,
...
class Primary_Caps(nn.Module):
    def _init_(self, in_channels, caps_units):
        super(Primary_Caps, self)._init_()
...
class Digits_Caps(nn.Module):
    def _init_(self, in_units, in_channels, num_units, unit_size):
        super(Digits_Caps, self)._init_()
...
class Conv_CBAM(nn.Module):
    ...
    def _init_(self, c1, c2, k=1, s=1, p=None, g=1, act=True):
        super(Conv_CBAM, self)._init_()
